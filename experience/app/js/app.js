...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
    .state('app', {
        ...
        resolve: helper.resolveFor('modernizr', 'icons', 'animo','ui-iconpicker')
    })
    // 
    // CUSTOM RESOLVES
  ...
  function($stateProvider, helper) {
    ...
    $stateProvider
      .state('app.OpenRequest', {
        url: '/OpenRequest',
        title: 'OpenRequest',
		controller:'OpenRequestController',
        templateUrl: helper.basepath('OpenRequest.html'),
        resolve: helper.resolveFor('datatables', 'sparklines', 'jquery-ui', 'jquery-ui-widgets', 'classyloader', 'moment', 'fullcalendar', 'flot-chart', 'flot-chart-plugins', 'morris', 'toastr', 'loadGoogleMapsJS', function() {
          return loadGoogleMaps();
        }, 'ui.map', 'angular-reverse-geocode-master','vector-map', 'vector-map-maps'),
        isRestricted: 'true'
...
/**=========================================================
 * Module: ClosedRequestController.js
 * Main Application Controller
 =========================================================*/

App.controller('ClosedRequestController', ['$rootScope', '$scope', '$state', '$http',
  function ($rootScope, $scope, $state, $http) {
      $scope.title = 'ViewSummary';
...
/**=========================================================
 * Module: PendingRequestController.js
 * Main Application Controller
 =========================================================*/

App.controller('PendingRequestController', ['$rootScope', '$scope', '$state', '$http',
  function ($rootScope, $scope, $state, $http) {
      $scope.title = 'ViewSummary';
 ...
 * Handle sidebar collapsible elements
 =========================================================*/
App.controller('SidebarController', ['$rootScope', '$scope', '$state', 'SidebarLoader', 'Utils',
  function($rootScope, $scope, $state, SidebarLoader,  Utils) {
        ...
        function activate() {
          ...
          $scope.toggleCollapse = function($index, isParentItem) {
            if($scope.app.asideToggled) {
              $scope.app.asideToggled = !$scope.app.asideToggled;
            }
...
App.controller('SummaryController', ['$rootScope', '$scope', '$state', '$http',
  function ($rootScope, $scope, $state, $http) {
      $scope.title = 'Summary';
...
(function() {
    ...
    function initCalendar(calElement, events, isRTL) {
        ...
        calElement.fullCalendar({
            ...
            drop: function(date, allDay) { // this function is called when something is dropped
                ...
                var themonth=dt.getMonth();
                var thetoday=dt.getDate();
                var monthNames = ["January", "February", "March", "April", "May", "June",
                                  "July", "August", "September", "October", "November", "December"
                                 ];
                console.log("Event created for date: "+monthNames[themonth]+" "+thetoday+" "+theyear+"\nEvent Name: "+clonedEventObject.title);
            },
    ...
    function initExternalEvents(calElement){
      ...
      eventAddBtn.click(function(e) {
          ...
          console.log("Created new Event: "+val);
      });
    }
...
(function() {
    ...
    App.directive('panelCollapse', panelCollapse);
...
(function() {
    ...
    App.directive('panelDismiss', panelDismiss);
...
(function() {
    ...
    App.directive('panelRefresh', panelRefresh);
...
(function() {
    ...
    App.directive('paneltool', paneltool);
...
(function() {
    ...
    App.directive('sparkline', sparkline);
...
(function() {
    'use strict';
        ...
        App.directive('checkAll', checkAll);
...
App.service('SidebarLoader', ['$http', function($http) {
  "use strict";
...
(function() {
   ...
   App.service('VectorMap', VectorMap);
